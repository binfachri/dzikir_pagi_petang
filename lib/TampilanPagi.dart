...
class TampilanPagi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: PageView(
          children: <Widget>[
            pagiItem("أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّجِيمِ",
            ...
            pagiItem("بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ",
  ...
  pagiItem(String arab, String arti) {
    return ListView(
      children: <Widget>[
        Padding(
